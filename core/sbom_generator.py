...
class SBOMComponent:
    def __init__(
        ...
        checksums: dict = None,  # e.g., {"md5": ..., "sha256": ...}
        comments: str = None,
        executable_property: str = None,
        archive_property: str = None,
        structured_property: str = None,
        unique_identifier: str = None,
        dependencies_field: str = None,
        vulnerabilities_field: str = None
    ):
        self.name = name
        ...
        self.executable_property = executable_property
        self.archive_property = archive_property
        self.structured_property = structured_property
        self.unique_identifier = unique_identifier
        self.dependencies_field = dependencies_field
        self.vulnerabilities_field = vulnerabilities_field
